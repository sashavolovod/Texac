...
{
    public partial class frmEndWorkReport : MyForm
    {
        ...
        private void frmEndWorkReport_Load(object sender, EventArgs e)
        {
            this.orders208TableAdapter.Fill(this.dataDataSet.Orders208);
